...
class AdaptiveMomentumStrategy(QCAlgorithm):
    def Initialize(self):
        ...
        self.Schedule.on(self.DateRules.every(DayOfWeek.MONDAY), self.TimeRules.after_market_open("SPY",5), self.WeeklyUpdate)
        self.Schedule.on(self.DateRules.everyDay("SPY"), self.TimeRules.after_market_open("SPY",60), self.CheckStopLoss)
