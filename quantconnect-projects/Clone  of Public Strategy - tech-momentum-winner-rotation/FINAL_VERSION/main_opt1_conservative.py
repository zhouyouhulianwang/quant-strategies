...
class AdaptiveMomentumStrategy(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.vix_threshold = 25.0  # VIX > 30 视为高风险
        self.vix_high_position_scale = 0.3  # 高风险时仓位减半
        
        # === 仓位管理 ===
        self.max_position_per_stock = 0.10
        ...
        # 暂停和临时增加条件
        self.vix_pause_threshold = 30   # VIX > 30：暂停调仓（延长周期）
